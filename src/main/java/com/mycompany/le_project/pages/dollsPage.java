 ...
 * @author rvadi
 */
public class dollsPage extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dollsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
