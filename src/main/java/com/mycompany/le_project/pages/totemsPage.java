...
import com.mycompany.le_project.*;

/**
 *
 * @author rvadi
 */
public class totemsPage extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(totemsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new totemsPage().setVisible(true);
            }
        });
    }
